...
<section class="app-user-view-account">
  <div class="row">
    ...
    <div class="col-xl-4 col-lg-5 col-md-5 order-1 order-md-0">
      <div class="col mb-2 md-4"><a href="javascript:void(0)" class="btn btn-success" id="new-material">Tambah Komposisi</a></div>
      <!-- User Card -->
      <div class="card">
        <div class="card-body"> 
    ...
    <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
      ...
      <ul class="nav nav-pills mb-2">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="{{ route('composition.index',$data->id) }}">
      ...
      <!-- Project table -->
      <div class="card">
        <h4 class="card-header">Komposisi</h4>
        <div class="table-responsive">
          ...
          @include('content.apps.user.modal-create-composition')
          @include('content.apps.user.modal-edit-composition')
      </div>
    </div>
  </div>
</section>
...
@section('page-script')
  ...
  <script>
    ...
    $('#update').click(function(e){
        ...
        let tonase = $('#tonase_edit').val();
        let percentage = $('#percentage_edit').val();
        $.ajax({
            url : 'update/'+id,
            type: 'PUT',
            cache: false,
    ...
    $('#store').click(function(e){
      ...
      $.ajax({
        url : `{{ route('composition.store', $data->id) }}`,
        type: "POST",
        dataType: 'json',
        data: {
          "item_code" : item_code,
    ...
    $('body').on('click', '.deleteData', function () {
     ...
     $.ajax({
         type: "DELETE",
         url:  "{{ route('composition.destroy') }}"+'/'+id1,
         cache: false,
