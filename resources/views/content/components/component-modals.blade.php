                  ...
                  <div class="modal-content">
                    ...
                    <form action="#">
                      <div class="modal-body">
                        ...
                        <div class="mb-1">
                          <input type="text" placeholder="Nomor Dokumen" id="document_number" class="form-control" required />
                        </div>

                        <label>Tanggal</label>
                        <div class="mb-1">
                          <input type="date" placeholder="Tanggal" id="document_date" class="form-control" required/>
                        </div>

                        <label>Trial Type</label>
                        <div class="mb-1">
                          <input type="text" placeholder="Trial Type" list="list" id="trial_type" class="form-control" />
                          <datalist id="list">
                        ...
                        <div class="mb-1">
                          <textarea placeholder="Trial Note" id="trial_note" class="form-control" >
                        </div>

                        <label>Kode Item</label>
                        <div class="mb-1">
                          <input type="text" placeholder="Kode Item" id="item_code" class="form-control" />
                        </div>

                        <label>Family Product</label>
                        <div class="mb-1">
                          <input type="text" placeholder="Family Product" id="family_product" class="form-control" />
                        </div>

                        <label>Nama Item</label>
                        <div class="mb-1">
                          <input type="text" placeholder="Nama Item" id="item_name" class="form-control" />
                        </div>

                        <label>Ukuran</label>
                        <div class="mb-1">
                          <input type="text" placeholder="Ukuran" id="size" class="form-control" />
                        </div>

                        <label>Note</label>
                        <div class="mb-1">
                          <textarea placeholder="Note" id="note" class="form-control" >
                        </div>

                        <label>Disetujui Oleh</label>
                        <div class="mb-1">
                          <input type="text" placeholder="Disetujui Oleh" id="approval_created_by" class="form-control" />
                        </div>

                        <label>Tanggal Disetujui</label>
                        <div class="mb-1">
                          <input type="date" placeholder="Tanggal Disetujui" id="approval_created_date" class="form-control" />
                        </div>

                        <label>Disetujui Oleh (Plant Head)</label>
                        <div class="mb-1">
                          <input type="text" placeholder="Disetujui Oleh (Plant Head)" id="approval_plant_head_name" class="form-control" />
                        </div>

                        <label>Tanggal Disetujui (Plant Head)</label>
                        <div class="mb-1">
                          <input type="date" placeholder="Tanggal Disetujui" id="approval_plant_head_date" class="form-control" />
                        </div>

                        <label>Disetujui Oleh (PPIC)</label>
                        <div class="mb-1">
                          <input type="text" placeholder="Disetujui Oleh" id="approval_ppic_name" class="form-control" />
                        </div>

                        <label>Tanggal Disetujui (PPIC)</label>
                        <div class="mb-1">
                          <input type="date" placeholder="Tanggal Disetujui" id="approval_ppic_date" class="form-control" />
                        </div>

                        <label>Disetujui Oleh (GM)</label>
                        <div class="mb-1">
                          <input type="text" placeholder="Disetujui Oleh" id="approval_gm_name" class="form-control" />
                        </div>

                        <label>Tanggal Disetujui (GM)</label>
                        <div class="mb-1">
                          <input type="date" placeholder="Tanggal Disetujui" id="approval_gm_date" class="form-control" />
                        </div>
                        ...
                        <div class="mb-1">
                          <input type="text" placeholder="Costing Staff" class="form-control" id="costing_staff_name"/>
                        </div>

                        <label>Disetujui Oleh (Costing)</label>
                        <div class="mb-1">
                          <input type="text" class="form-control" placeholder="Disetujui Oleh" id="costing_approval_name"/>
                        </div>

                        <label>Tanggal Disetujui (Costing)</label>
                        <div class="mb-1">
                          <input type="date" class="form-control" placeholder="Tanggal Disetujui" id="costing_approval_date"/>
                        </div>
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal" id="store">Simpan</button>
                      </div>
                    </form>
                  </div>
                </div>
