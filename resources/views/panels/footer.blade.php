...
<footer
  ...
  <p class="clearfix mb-0">
    <span class="float-md-start d-block d-md-inline-block mt-25">COPYRIGHT &copy;
      ...
      </script><a class="ms-25" href="http:\\sinarjoyoboyo.com"
        target="_blank">ICTEA</a>,
      <span class="d-none d-sm-inline-block">All rights Reserved</span>
    </span>
    <span class="float-md-end d-none d-md-block">Trial Report<i data-feather="file-text"></i></span>
  </p>
</footer>
